...
public class StatusAilmentImpl implements StatusAilment {
    ...
    // 状態異常を変化させる場合
    public static StatusAilment changeAilment(PokeInfo target, Ailment value) throws InterruptedException {
        return new StatusAilmentImpl(target, value);
    }

    private StatusAilmentImpl(PokeInfo target, Ailment value) throws InterruptedException {
    ...
    private boolean isOverwrite(PokeInfo target, Ailment value) {
        // 元の状態異常
